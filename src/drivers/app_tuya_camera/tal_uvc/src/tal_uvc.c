...
/* tuya_port_disp.h (old src/miscs/gui GUI layer) include removed: only tkl_dma2d_*
 * was used here and those are declared in tkl_dma2d.h below. Decouples tal_uvc from
 * the legacy UI so it can be retired (new UI framework lives under src/ui). */
#include "tkl_dma2d.h"
#endif
