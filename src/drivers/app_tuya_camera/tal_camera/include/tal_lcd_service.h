 ...
 * typically from the camera video input source (video_input_camera.c) after
 ...
 *         Call from the camera video input source (video_input_camera.c) so
 *         the UI can reclaim DMA2D.
 */
