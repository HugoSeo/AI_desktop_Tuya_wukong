...
// Must be moved KJ
//#define __GNUC__
/* Do NOT hardcode ARM/ARM_ADS here. These force assembly.h's ARM_ADS branch,
 * which declares MULSHIFT32/FASTABS as extern (xmp3_*) backed by hand-written
 * asm files this tree does not ship, and omits MADD64/SAR64 entirely — both
 * cause link-time undefined references. Rely on the toolchain-defined __arm__
 * and __GNUC__ instead, so assembly.h selects its inline GCC/ARMv7-M
 * (smull/smlal) path. */
