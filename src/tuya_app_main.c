...
#ifndef PID 
    // #define PID  "9inb01mvjqh5zhhr"     /* for normal test */
    #define PID  "owmlbbc3auumktx5"        /*小康机器人*/
    // #define PID  "ffi9j3ovc5o3aifi"     /* for translate test */
    // #define PID  "kh0hig0fdtlzndvg"     /* for picture generation test */
#endif
...
STATIC VOID_T __soc_dev_status_changed_cb(IN CONST GW_STATUS_E status)
{
    ...
    // flag_gateway_state = status;    //Add by Hugo 26.06.24
}
...
OPERATE_RET __soc_device_init(VOID_T)
{
    ...
    // UINT8_T buf[10] = {0x55,0xAA,0x05,0x01,0xAB,0xBC};
    // tal_uart_write(TUYA_UART_NUM_0, buf, 10);
