...
OPERATE_RET wukong_ai_chat_sub_mode_cycle(VOID)
{
    ...
    AI_CHAT_SUB_MODE_E next = AI_CHAT_SUB_FREE;             //just Free chat mode.  Modefied by Hugo 26.06.19
    INT_T count = 0;
    ...
    while (count++ < AI_CHAT_SUB_MAX) {
        ...
        next = AI_CHAT_SUB_FREE;             //just Free chat mode.  Modefied by Hugo 26.06.19
    }
