 ...
 * Size: 28 px
 * Bpp: 4
 * Opts: --bpp 4 --size 28 --no-compress --force-fast-kern-format --font Montserrat-Medium.ttf -r 0x20,0x2D,0x30-0x3A --format lvgl -o lv_font_montserrat_28.c
 ******************************************************************************/

/* Subset replacement for LVGL's built-in lv_font_montserrat_28:
 * only countdown-face digits for the clock page.
 * Keep LV_FONT_MONTSERRAT_28=0 in lv_conf.h: this file is always compiled and
