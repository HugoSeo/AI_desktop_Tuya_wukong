 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --bpp 4 --size 48 --no-compress --force-fast-kern-format --font Montserrat-Medium.ttf -r 0x20,0x2D,0x30-0x3A --format lvgl -o lv_font_montserrat_48.c
 ******************************************************************************/

/* Subset replacement for LVGL's built-in lv_font_montserrat_48:
 * only timer-face digits for clock/pomodoro/recording/home pages.
 * Keep LV_FONT_MONTSERRAT_48=0 in lv_conf.h: this file is always compiled and
