...
extern void stub_set_millis(SYS_TIME_T t);
extern void stub_advance_millis(SYS_TIME_T delta);
...
int main(void)
{
    ...
    EXPECT_EQ(state.elapsed_ms, 30120, "elapsed should preserve milliseconds");
    ...
    EXPECT_EQ(state.elapsed_ms, 0, "fresh start should have 0 elapsed milliseconds");
