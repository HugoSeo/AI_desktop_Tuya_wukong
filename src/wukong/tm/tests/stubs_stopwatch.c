...
SYS_TIME_T tal_system_get_millisecond(VOID_T) { return s_fake_millis; }
void stub_set_millis(SYS_TIME_T t) { s_fake_millis = t; }
void stub_advance_millis(SYS_TIME_T delta) { s_fake_millis += delta; }
