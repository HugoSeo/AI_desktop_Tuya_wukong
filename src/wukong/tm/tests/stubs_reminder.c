...
/* Must hold full SYS_TTS_NOTIFY prompt + triple-quoted reminder (UTF-8). */
CHAR_T g_last_ai_send_text[1024] = {0};
...
/* ---- persistence ----
 * Provided by the storage record layer (wukong_storage_*), backed in host
 * tests by the RAM double in tests_common/stubs_storage.c. */
