...
/* Persistence is provided by the storage record layer (wukong_storage_*),
 * backed in host tests by the RAM double in tests_common/stubs_storage.c. */

/* reminder kv_clear stub (reminder.c not compiled for alarm test) */
