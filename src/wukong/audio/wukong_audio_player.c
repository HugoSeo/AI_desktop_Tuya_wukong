...
// #include "../../../include/hugo_ai_desktop.h"
...
// STATIC GW_STATUS_E flag_gateway_state = 0;
...
OPERATE_RET wukong_audio_player_alert(TY_AI_TOY_ALERT_TYPE_E type, BOOL_T send_eof)
{
    ...
    // TY_IOT_CBS_S iot_cbs1 = {0};
    // iot_cbs1.gw_status_cb    = __soc_dev_status_changed_cb1;
    ...
    case AI_TOY_ALERT_TYPE_NETWORK_CONNECTED:
        ...
        // TUYA_CALL_ERR_LOG(wukong_ai_agent_send_text("不要加任何修饰，不要重复，直接朗读:已联网,开始我们的聊天吧"));
        // tuya_ai_input_stop();
        audio_data = (CONST CHAR_T*)media_src_connected_zh;
        audio_size = sizeof(media_src_connected_zh);
        break;
    case AI_TOY_ALERT_TYPE_WAKEUP: 
        // TUYA_CALL_ERR_LOG(ret_gateway_state());
        // if(flag_gateway_state == 3)
        ...
        {
            // tuya_ai_input_start(TRUE);
            // TUYA_CALL_ERR_LOG(wukong_ai_agent_send_text("说一次下面这个词,我在"));
            // TUYA_CALL_ERR_LOG(wukong_ai_agent_send_text("不要加任何修饰，不要重复，直接朗读:我在呢"));
            // tuya_ai_input_stop();
