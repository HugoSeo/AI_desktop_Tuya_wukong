...
LOCAL_TUYA_SDK_INC += $(LOCAL_PATH)/src/view
LOCAL_SRC_FILES += $(shell find $(LOCAL_PATH)/src/view -maxdepth 1 -name "*.c" -o -name "*.cpp" -o -name "*.cc")
LOCAL_SRC_FILES += $(shell find $(LOCAL_PATH)/src/view/res -name "*.c" -o -name "*.cpp" -o -name "*.cc")
